import { GetListResponse, HttpError, UseLoadingOvertimeReturnType } from "@refinedev/core";
...
return (
  <div className="w-full flex flex-col items-center justify-center">
    ...
    <div>
      {isLoading && !isFetchingNextPage ? <Loader className="w-5 h-5 animate-spin" /> : null}
    </div>
  </div>
);
}
